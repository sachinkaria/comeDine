...
ActiveRecord::Schema.define(version: 20160614171636) do
  ...
  add_index "reviews", ["table_id"], name: "index_reviews_on_table_id", using: :btree
  ...
  add_foreign_key "reviews", "tables"
