...
describe MealsController, "testing meals" do
  before(:all) do
    ...
    FirstMeal = @table.meals.create(menu: "Pasta", date: "2015-06-06", time: "20:00", places: 4, cuisine_id: 1 )
    SecondMeal = @table.meals.create(menu: "Pizza", date: "2015-07-07", time: "20:00", places: 2, cuisine_id: 2 )
  end
  ...
  it "allows user to create a meal", type: :request do
    params = {menu: "Fish and Chips", date: "2015-07-07", time: "20:00", places: 2, cuisine_id: 2}
